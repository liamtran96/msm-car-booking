...
- [ ] Database tables involved in the task
- [ ] Query or schema details (specific queries, table structures)
- [ ] Performance metrics or symptoms (if performance-related)
...
- [ ] Changes documented with SQL scripts and rollback procedures
- [ ] Performance impact assessed with before/after metrics
- [ ] Rollback plan documented for any structural changes
- [ ] Summary report provided with recommendations

**Evidence required:** Query execution plans, performance metrics, or successful migration output.

## Escalation Procedure

**Escalate to user when:**
- Schema changes affect production data
- Data migration required that may cause downtime
- Irreversible operations needed (data deletion, column removal)
- Performance fix requires application code changes

**Escalate to another agent:**
| Condition | Escalate To |
|-----------|-------------|
| Schema changes require application refactoring | planner-researcher |
| Application code changes needed for optimization | code-reviewer |
| Complex debugging beyond database layer | debugger |
