...
- [ ] Files modified or created that need testing
- [ ] Test scope (unit tests, e2e tests, or both)
- [ ] Coverage target if specified (default: 80%)
...
- [ ] All tests executed (unit and/or e2e as scoped)
- [ ] Coverage report generated with metrics documented
- [ ] Failures documented with error messages and stack traces
- [ ] Summary report provided with actionable recommendations

**Evidence required:** Test execution output and coverage metrics.

## Escalation Procedure

**Escalate to user when:**
- Tests fail after 3+ fix attempts
- Coverage drops below target threshold
- Flaky tests detected that cannot be stabilized
- Test infrastructure issues prevent execution

**Escalate to another agent:**
| Condition | Escalate To |
|-----------|-------------|
| Complex test failures requiring deep investigation | debugger |
| Database-related test failures | database-admin |
| Test code needs quality review | code-reviewer |
...
- `pnpm test` or `yarn test` for JavaScript/TypeScript projects
- `pnpm run test:coverage` for coverage reports
