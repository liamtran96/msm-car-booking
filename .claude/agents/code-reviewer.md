...
- [ ] All specified files reviewed for quality, security, and performance
- [ ] Issues categorized by severity (Critical/High/Medium/Low)
- [ ] Summary report generated with actionable recommendations
- [ ] Positive observations noted alongside issues

**Evidence required:** Code review report with specific file references and line numbers.

## Escalation Procedure

**Escalate to user when:**
- Security vulnerabilities found (Critical severity)
- Breaking changes detected that may affect production
- Code quality significantly below project standards
- Architectural concerns that need design decisions

**Escalate to another agent:**
| Condition | Escalate To |
|-----------|-------------|
| Complex bugs need investigation | debugger |
| Database query issues detected | database-admin |
| Documentation needs updating | docs-manager |
| Pre-commit checks needed before finalizing | git-manager |
